...
menubar = require('menubar')({ dir: __dirname, index: 'file://' + path.join(__dirname, 'login.html'), icon: path.join(__dirname, 'img/picshare_logoTemplate.png'), resizable: no, preloadWindow: yes })
Tray = electron.Tray
Menu = electron.Menu
